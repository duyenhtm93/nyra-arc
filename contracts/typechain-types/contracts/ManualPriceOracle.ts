...
export interface ManualPriceOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_STALE_TIME"
      | "getPrice"
  ...
  encodeFunctionData(
    functionFragment: "MAX_STALE_TIME",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ManualPriceOracle extends BaseContract {
  connect(runner?: ContractRunner | null): ManualPriceOracle;
  waitForDeployment(): Promise<this>;

  interface: ManualPriceOracleInterface;
  ...
  MAX_STALE_TIME: TypedContractMethod<[], [bigint], "view">;
  ...
  setPrices: TypedContractMethod<
    [tokens: AddressLike[], priceList: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "MAX_STALE_TIME"
